...
Public Class testrepfollowproddataentryform
    Private sqlServerConnectionString As String = "Server=180.1.1.6;Database=wmg-po;User Id=sa;Password=admin@WMG2024;"

    Private Sub testrepfollowproddataentryform_Load(sender As Object, e As EventArgs) Handles MyBase.Load
        LoadTrackingData()
    End Sub
  ...
  "LEFT JOIN contracts ON td.contract_id = contracts.ContractID " &
  "LEFT JOIN clients ON contracts.ClientCode = clients.id " &
  "WHERE NOT EXISTS (SELECT 1 FROM itdata pl WHERE pl.worderid = td.worderid) " &
