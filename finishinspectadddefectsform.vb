...
Public Class finishinspectadddefectsform
    ...
    Private Sub btninsert_Click(sender As Object, e As EventArgs) Handles btninsert.Click
        Dim queryCheck As String = "SELECT COUNT(*) FROM gray_defects WHERE name_ar = @name_ar and raw = 0"
            ...
            Using commandCheck As New SqlCommand(queryCheck, connection)
                ...
                Else
                    Using commandInsert As New SqlCommand(queryInsert, connection)
                        commandInsert.Parameters.AddWithValue("@raw", 0)
