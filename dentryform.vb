...
Public Class dentryform
    ...
    Private Sub dentryform_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
        LoadWorderIDs()
    ...
    Private Sub cmbworder_SelectediIndexChanged(ByVal sender As Object, ByVal e As EventArgs) Handles cmbworder.SelectedIndexChanged
        ...
        Dim query As String = "SELECT np.id, np.proccess_ar " &
            ...
            Try
                ...
                While reader.Read()
                    ...
                    If Not String.IsNullOrEmpty(proccessAr) Then
                        AddDynamicControls(proccessAr, yPos, npId)
    ...
    Private Function CheckIfLibCodeExistsInPlanning(ByVal npId As Integer) As Boolean
        Dim query As String = "SELECT COUNT(*) from itdata WHERE worderid = @worderid AND proccessid = @proccessid"
    ...
    Private Sub AddDynamicControls(ByVal proccessAr As String, ByRef yPos As Integer, ByVal npId As Integer)
    ...
    Private Sub btnInsert_Click(ByVal sender As Object, ByVal e As EventArgs) Handles btnInsert.Click
        ...
        For Each chkBox As CheckBox In Panel1.Controls.OfType(Of CheckBox)()
            ...
            FirstOrDefault(Function(dtp) Math.Abs(dtp.Location.Y - currentChkBox.Location.Y) <= 10 AndAlso dtp.Name = "dtpTimeOut")
                ...
                Dim queryMachinePlanning As String = "INSERT into itdata (qtykg, qtym, machineid, proccessid, worderId, datein, timein, dateout, timeout, total_time, datetrans, username) " &
                                             "VALUES (@qtykg, @qtym, @machineid, @proccessid, @worderid, @datein, @timein, @dateout, @timeout, @total_time, @datetrans, @username)"
                ...
                Using conn As New SqlConnection(sqlServerConnectionString)
                    Using cmd As New SqlCommand(queryMachinePlanning, conn)
                        ...
                        Catch ex As Exception
                            MessageBox.Show("Error inserting data into itdata: " & ex.Message)
                        End Try
                    End Using
                End Using
            End If
